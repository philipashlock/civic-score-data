...
function format_label($label) {
    ...
    if (!empty($entity)) {
	?>
  <div id="schoolinfo" class="row-fluid">
	
	<?php if (!empty($district)): ?>


	<div id="districtHead" class="row-fluid displayboxHead">
			
			<h4 class="pull-left">District</h4>
		
			<div class="pull-right">
				<?php if (!empty($district_status['status'])): ?>
					<span class="label<?php echo format_label($district_status['status'])?>"><?php echo ucwords($district_status['status']); ?></span>			
				<?php else : ?>
     ...
     <div class="row-fluid" id="districtName">

	 		<div class="row-fluid infobox-heading">
	...
	<div id="schoolHead" class="row-fluid displayboxHead">
		
			<h4 class="pull-left">School</h4>

			<div class="pull-right">
				<?php if (!empty($status['status'])): echo ""?>
				  <span class="label<?php echo format_label($status['status'])?>"><?php echo ucwords($status['status']); ?></span>
				<?php else : ?>
					<span class="label">No Status Data Found</span>
				<?php endif ?>
			</div>	
     ...
     <div class="row-fluid" id="schoolName">

	 		<div class="row-fluid infobox-heading">
					<h3><?php echo $entity['full_name']; ?></h3>		         
			</div>

	 		<div class="row-fluid" id="schoolInfo">

      ...
      <div id="newInfo" class="form-horizontal">
        <fieldset>      
          ...
          <div class="control-group">
            ...
            <div class="controls"><input type="text" class="datePicker" id="inputTeacherOpen" name="open_date_teachers" placeholder="##/##/####" value="<?php if (!empty($status['open_date_teachers']) && strtotime($status['open_date_teachers']) > 0) echo date("m/d/Y", strtotime($status['open_date_teachers'])); ?>"></div>
          </div>
          
          <div class="control-group">
            <label class="control-label" for="inputStudentOpen">When does/did your school open for students? </label>
            <div class="controls"><input type="text" class="datePicker" id="inputStudentOpen" name="open_date_student" placeholder="##/##/####" value="<?php if (!empty($status['open_date_student']) && strtotime($status['open_date_student']) > 0) echo date("m/d/Y", strtotime($status['open_date_student'])); ?>"></div>
          </div>
